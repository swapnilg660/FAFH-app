  ...
  let pages = [
    {
      ...
      image: (
        <Image
          ...
          source={require("./OnboardingPageOne.png")}
        />
      ),
      title: "Scan food",
      subtitle:
    ...
    },
    {
      ...
      image: (
        <Image
          style={{ width: "70%", resizeMode: "contain" }}
          source={require("./OnboardingPageTwo.png")}
        />
      ),
    ...
    },
    {
      ...
      image: (
        <Image
          style={{ width: "70%", resizeMode: "contain" }}
          source={require("./OnboardingPageThree.png")}
        />
      ),
  ...
  return (
    <Box flex={1}>
      <Onboarding
        ...
        subTitleStyles={{ fontFamily: "Poppins-Light", textAlign: "center" }}
      />
    </Box>
  );
}
